      ...
      if (!header.startsWith('%PDF')) {
        ...
        if (decodedText && decodedText.trim().startsWith('{')) {
          try {
            ...
            // ignore parse errors and fall through to original failure handling
            console.warn('Export PDF: failed to parse JSON fallback for PDF reconstruction', parseErr)
          }
        }
      }
