...
export async function apiFetch(url, options = {}) {
  ...
  // Remove x-user-id header to avoid CORS preflight issues
  // The server should rely on JWT token instead

  const fetchOptions = { 
    mode: 'cors',
    credentials: 'include', // Revert back to include since server should handle this
    ...options, 
    headers 
  }
