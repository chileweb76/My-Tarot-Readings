...
export async function apiFetch(url, options = {}) {
  ...
  try {
  const rawRefresh = await fetch(`${apiBase}/api/auth/refresh`, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ refreshToken }), credentials: fetchOptions.credentials })
