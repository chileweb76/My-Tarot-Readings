...
/    console.log('🚀 uploadImageToBlob: Using UPLOAD-IMAGE endpoint (brand new name):', finalUrl)
    console.log('🚀 uploadImageToBlob: File info:', { name: imageFile.name, size: imageFile.size, type: imageFile.type })
    
    // Skip CORS test and go straight to the upload endpointhese functions run in the browser, avoiding Server Action conflicts
