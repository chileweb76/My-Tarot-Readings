...
export async function uploadImageToBlob(readingId, imageFile) {
  try {
    ...
    // Use V2 endpoint for actual upload
    const url = `${apiBaseUrl}/api/blob-upload-v2?readingId=${readingId}&t=${cacheBuster}`
    
    console.log('🔵 uploadImageToBlob: Using V2 endpoint to bypass CORS cache:', url)
