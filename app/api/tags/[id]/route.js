...
// DELETE /api/tags/[id] - Delete specific tag (requires authentication)
export async function DELETE(request, { params }) {
  try {
    ...
    console.log('Proxying delete tag request to:', url)
    ...
    if (!response.ok) {
      ...
      console.error('Backend delete tag error:', response.status, errorData)
      return NextResponse.json(
    ...
    console.error('Delete tag API proxy error:', error)
    return NextResponse.json(
